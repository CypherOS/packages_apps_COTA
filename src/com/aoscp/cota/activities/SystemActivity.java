package com.aoscp.cota.activities;
...
import com.aoscp.cota.helpers.DownloadHelper;
...
public class SystemActivity extends AppCompatActivity implements UpdaterListener, 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mNotificationInfo != null) {
            if (mNotificationInfo.mNotificationId == UpdateService.NOTIFICATION_ID) {
    ...
    protected void onResume() {
		...
		UpdateService.stopNotificationUpdate(this);
    }
