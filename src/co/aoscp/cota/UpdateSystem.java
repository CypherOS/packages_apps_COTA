...
public class UpdateSystem extends ObservableActivity implements UpdaterListener, 
    ...
    protected void initViews() {
		...
		if (mAction != null) {
            mAction.setOnClickListener(mActionListener);
        }
    }
        ...
        switch (mState) {
            ...
            case STATE_CHECK:
                if (mUpdatePackage == null) {
					...
					mActionIcon.setImageDrawable(R.drawable.ic_action_check);
                    mAction.setText(R.string.update_system_action_check);
            ...
            case STATE_FOUND:
                if (!mRomUpdater.isScanning() && mUpdatePackage != null) {
					...
					mActionIcon.setImageDrawable(R.drawable.ic_action_download_install);
                    mAction.setText(R.string.update_system_action_download);
	                //mProgressBar.setVisibility(View.GONE);
                }
                break;
            case STATE_DOWNLOADING:
				...
				mActionIcon.setImageDrawable(R.drawable.ic_action_cancel);
                mAction.setText(R.string.update_system_action_cancel);
            ...
            case STATE_INSTALL:
				...
				mActionIcon.setImageDrawable(R.drawable.ic_action_download_install);
                mAction.setText(R.string.update_system_action_install);
		        //mProgressBar.setVisibility(View.GONE);
                break;
        }
    }
